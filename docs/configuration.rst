...
Let's start from the first configuration variable and work out way down.

1. **output:** this defines a default output file location *relative to your working directory*, unless you use an absolute path.
2. **logging_level:** How verbose you want *the command line stdout logging*. Note: this will not affect your verbose logfile that is being stored as a immutable reference.
...
7. **gff:** Same concept as the (6 - fasta) above.
